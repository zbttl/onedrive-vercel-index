...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'zbttl@foxmail.com',

  // [OPTIONAL] This is the website icon to the left of the title inside the navigation bar. It should be placed under the
  // /public directory of your GitHub project (not your OneDrive folder!), and ！ here by its relative path to /public.
  icon: '/icons/128.png',
  ...
  email: 'mailto:zbttl@foxmail.com',
